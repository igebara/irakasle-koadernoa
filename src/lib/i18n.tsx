...
const translations: Record<Lang, Dict> = {
  eu: {
    ...
    "nav.gradebook": "Ikuspegi orokorra",
    "nav.assignments": "Neurketak",
    "nav.programazioa": "Programazioa",
    "nav.ebaluazioa": "Ebaluazioa",
    ...
    "hero.newAssignment": "Neurketa berria",
    ...
    "stats.toGrade": "Ebaluatzeko atazak",
    ...
    "assign.title": "Ebaluatzeko atazak",
    "assign.subtitle": "28 entrega zain",
    "assign.new": "Berria",
    "assign.col.assignment": "Jarduera konpetentziala",
    ...
    "page.gradebook.title": "Ikuspegi orokorra",
    "page.gradebook.subtitle": "Azken probak eta lanen notak",
    "gradebook.subject": "Ikasgaia",
    "comp.title": "Konpetentziak",
    "comp.level": "Konpetentzia-maila",
    "comp.level.1": "Hasierakoa",
    "comp.level.2": "Egokia",
    "comp.level.3": "Aurreratua",
    "comp.level.4": "Bikaina",
    "comp.view.numeric": "Zenbakizkoa",
    "comp.view.competency": "Konpetentziala",
    "comp.measured": "Neurtutako konpetentziak",
    "comp.indicator": "Ebaluazio adierazlea",
    "comp.indicators": "ebaluazio adierazle",
    "comp.summary": "Konpetentzien laburpena",
    "assign.edit": "Neurketak editatu",
    "assign.measure.title": "Konpetentziak eta ebaluazio adierazleak neurtu",
    "page.programazioa.title": "Urteko programazioa",
    "page.programazioa.subtitle": "Konpetentziak eta ebaluazio adierazleak diseinatu Euskal Curriculumetik",
    "programazioa.newUnit": "Unitate berria",
    "programazioa.empty": "Oraindik ez dago unitaterik. Sortu lehenengoa.",
    "prog.new": "Programazio berria",
    "prog.empty": "Asignatura honetan ez dago programaziorik. Sortu berria.",
    "prog.actions.edit": "Editatu",
    "prog.actions.copy": "Kopiatu",
    "prog.actions.assign": "Esleitu",
    "prog.actions.download": "Deskargatu",
    "prog.actions.delete": "Ezabatu",
    "prog.sections.details": "Xehetasunak",
    "prog.sections.justification": "Justifikazioa",
    "prog.sections.situations": "Ikas-egoerak eta ataza konpetentzialak",
    "prog.sections.methodology": "Metodologia",
    "prog.sections.evaluation": "Ebaluazioaren erabakiak",
    "prog.sections.files": "Fitxategiak eta estekak",
    "prog.summary.title": "Programazioaren laburpena",
    "prog.assign.groups": "Taldeak",
    "prog.assign.students": "Ikasleak",
    "prog.assign.exclusiveWarning": "Oharra: ikasle batek asignatura beraren programazio bakarra izan dezake. Esleitzean, beste programazioetatik kenduko da.",
    "common.reset": "Berrezarri",
    "page.assignments.title": "Neurketak",
    "page.assignments.subtitle": "Ataza konpetentzialen neurketak",
    "assign.overview": "Ikuspegi orokorra",
    "assign.editMode": "Edizio modua",
    "assign.newMeasurement": "Neurketa berria",
    "assign.pickTask": "Aukeratu programazioko ataza konpetentziala",
    "assign.subjectClass": "Ikasgaia eta klasea",
    "assign.filterEgoera": "Ikas-egoera",
    "assign.filterEbal": "Ebaluazioa",
    "assign.allEgoerak": "Guztiak",
    "assign.editExclusiveWarning": "Beste ataza baten edizio modua aktibo dago. Itxi lehenik.",
    "page.ebaluazioa.title": "Ebaluazioa",
    "page.ebaluazioa.subtitle": "Hiruhilekoen laburpena, oharrak eta inprimaketa",
    "ebal.eval1": "1. ebaluazioa",
    "ebal.eval2": "2. ebaluazioa",
    "ebal.eval3": "3. ebaluazioa",
    "ebal.ohikoa": "Ohikoa",
    "ebal.tutorNote": "Oharrak tutorearentzat",
    "ebal.parentsNote": "Oharrak gurasoentzat",
    "ebal.print": "Inprimatu",
  ...
  es: {
    ...
    "nav.gradebook": "Vista general",
    "nav.assignments": "Mediciones",
    "nav.programazioa": "Programación",
    "nav.ebaluazioa": "Evaluación",
    ...
    "hero.newAssignment": "Nueva medición",
    ...
    "page.gradebook.title": "Vista general",
    "page.gradebook.subtitle": "Últimas pruebas y notas",
    "gradebook.subject": "Asignatura",
    "comp.title": "Competencias",
    "comp.level": "Nivel competencial",
    "comp.level.1": "Inicial",
    "comp.level.2": "Adecuado",
    "comp.level.3": "Avanzado",
    "comp.level.4": "Excelente",
    "comp.view.numeric": "Numérica",
    "comp.view.competency": "Competencial",
    "comp.measured": "Competencias evaluadas",
    "comp.indicator": "Indicador de evaluación",
    "comp.indicators": "indicadores de evaluación",
    "comp.summary": "Resumen competencial",
    "assign.edit": "Editar mediciones",
    "assign.measure.title": "Medir competencias e indicadores",
    "page.programazioa.title": "Programación anual",
    "page.programazioa.subtitle": "Diseña competencias e indicadores desde el Currículo Vasco",
    "programazioa.newUnit": "Nueva unidad",
    "programazioa.empty": "Aún no hay unidades. Crea la primera.",
    "prog.new": "Nueva programación",
    "prog.empty": "No hay programaciones en esta asignatura. Crea una nueva.",
    "prog.actions.edit": "Editar",
    "prog.actions.copy": "Copiar",
    "prog.actions.assign": "Asignar",
    "prog.actions.download": "Descargar",
    "prog.actions.delete": "Eliminar",
    "prog.sections.details": "Detalles",
    "prog.sections.justification": "Justificación",
    "prog.sections.situations": "Situaciones de aprendizaje y tareas competenciales",
    "prog.sections.methodology": "Metodología",
    "prog.sections.evaluation": "Decisiones de evaluación",
    "prog.sections.files": "Archivos y enlaces",
    "prog.summary.title": "Resumen de la programación",
    "prog.assign.groups": "Grupos",
    "prog.assign.students": "Alumnos",
    "prog.assign.exclusiveWarning": "Aviso: un alumno solo puede tener una programación por asignatura. Al asignar, se retirará de otras programaciones.",
    "common.reset": "Reiniciar",
    "page.assignments.title": "Mediciones",
    "page.assignments.subtitle": "Mediciones de tareas competenciales",
    "assign.overview": "Vista general",
    "assign.editMode": "Modo edición",
    "assign.newMeasurement": "Nueva medición",
    "assign.pickTask": "Elegir tarea competencial de la programación",
    "assign.subjectClass": "Asignatura y clase",
    "assign.filterEgoera": "Situación de aprendizaje",
    "assign.filterEbal": "Evaluación",
    "assign.allEgoerak": "Todas",
    "assign.editExclusiveWarning": "Otra tarea está en modo edición. Ciérrala primero.",
    "page.ebaluazioa.title": "Evaluación",
    "page.ebaluazioa.subtitle": "Resumen trimestral, notas e impresión",
    "ebal.eval1": "1ª evaluación",
    "ebal.eval2": "2ª evaluación",
    "ebal.eval3": "3ª evaluación",
    "ebal.ohikoa": "Ordinaria",
    "ebal.tutorNote": "Notas para el tutor/a",
    "ebal.parentsNote": "Notas para los padres",
    "ebal.print": "Imprimir",
  ...
  en: {
    ...
    "nav.gradebook": "Overview",
    "nav.assignments": "Measurements",
    "nav.programazioa": "Year planning",
    "nav.ebaluazioa": "Evaluation",
    ...
    "hero.newAssignment": "New measurement",
    ...
    "comp.level.1": "Initial",
    "comp.level.2": "Adequate",
    "comp.level.3": "Advanced",
    "comp.level.4": "Excellent",
    "comp.view.numeric": "Numeric",
    "comp.view.competency": "Competency",
    "comp.measured": "Measured competencies",
    "comp.indicator": "Evaluation indicator",
    "comp.indicators": "evaluation indicators",
    "comp.summary": "Competency summary",
    "assign.edit": "Edit measurements",
    "assign.measure.title": "Measure competencies & indicators",
    "page.programazioa.title": "Year planning",
    "page.programazioa.subtitle": "Design competencies and indicators from the Basque Curriculum",
    "programazioa.newUnit": "New unit",
    "programazioa.empty": "No units yet. Create the first one.",
    "prog.new": "New program",
    "prog.empty": "No programs for this subject yet. Create one.",
    "prog.actions.edit": "Edit",
    "prog.actions.copy": "Copy",
    "prog.actions.assign": "Assign",
    "prog.actions.download": "Download",
    "prog.actions.delete": "Delete",
    "prog.sections.details": "Details",
    "prog.sections.justification": "Justification",
    "prog.sections.situations": "Learning situations and competential tasks",
    "prog.sections.methodology": "Methodology",
    "prog.sections.evaluation": "Evaluation decisions",
    "prog.sections.files": "Files and links",
    "prog.summary.title": "Program summary",
    "prog.assign.groups": "Groups",
    "prog.assign.students": "Students",
    "prog.assign.exclusiveWarning": "Note: a student can only have one program per subject. Assigning here removes them from other programs.",
    "common.reset": "Reset",
    "page.assignments.title": "Measurements",
    "page.assignments.subtitle": "Competential task measurements",
    "assign.overview": "Overview",
    "assign.editMode": "Edit mode",
    "assign.newMeasurement": "New measurement",
    "assign.pickTask": "Pick a competential task from your program",
    "assign.subjectClass": "Subject & class",
    "assign.filterEgoera": "Learning situation",
    "assign.filterEbal": "Evaluation",
    "assign.allEgoerak": "All",
    "assign.editExclusiveWarning": "Another task is in edit mode. Close it first.",
    "page.ebaluazioa.title": "Evaluation",
    "page.ebaluazioa.subtitle": "Term summary, notes and printing",
    "ebal.eval1": "1st evaluation",
    "ebal.eval2": "2nd evaluation",
    "ebal.eval3": "3rd evaluation",
    "ebal.ohikoa": "Ordinary",
    "ebal.tutorNote": "Notes for tutor",
    "ebal.parentsNote": "Notes for parents",
    "ebal.print": "Print",
